        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-14 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            ...
            <Reveal delay={0} className="h-full">
              ...
              >
                {/* Photo container — overflow-hidden prevents scale leak */}
                <div className="relative w-full h-[420px] overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#09090b] via-[#09090b]/30 to-transparent pointer-events-none" />
                ...
                {/* Info — margin-top negative to overlap gradient zone, eliminates any gap */}
                <div className="relative z-10 p-7 -mt-10 bg-gradient-to-t from-[#09090b] from-60% to-transparent">
